-- Adel Abdallah, PhD Candidate, Utah State University, December 2018

-- This is a Data Definition Language (DDL) script that
-- generates a blank schema of the Water Management Data Model (WaMDaM)
-- for SQLite database

-- Generated by Adel Abdallah December, 2018 based on WaMDaM XML design named WaMDaM_DBWrench_Schema_1.05.xml generated by DbWrench V4.04 @ http://www.dbwrench.com/ 
...
CREATE TABLE CategoricalValues (
	CategoricalValueID INTEGER  AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE FreeText (
	FreeTextID INTEGER  AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE ResourceTypes (
	...
	MethodID INTEGER   NOT NULL,
	Description TEXT   NULL,
	FOREIGN KEY (ResourceTypeCV) REFERENCES CV_ResourceType (Name)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (MethodID) REFERENCES Methods (MethodID)
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
