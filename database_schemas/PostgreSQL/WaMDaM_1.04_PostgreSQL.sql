-- Adel M. Abdallah, PhD Candidate, Utah State University, May 2018

--This is a Data Definition Language (DDL) script that
--generates a blank schema of the Water Management Data Model (WaMDaM)
--for PostgreSQL database

-- Generated by Adel Abdallah May, 2018 based on WaMDaM XML design named WaMDaM_DBWrench_Schema_1.02.xml DbWrench V4.04 @ http://www.dbwrench.com
